...
@EnableJpaRepositories(basePackages = "com.e201.domain.repository.contract",
	entityManagerFactoryRef = "contractEntityManagerFactory",
	transactionManagerRef = "jtaTransactionManager")
public class ContractConfig {

	@Bean
	public LocalContainerEntityManagerFactoryBean contractEntityManagerFactory(DataSource contractDataSource) {
