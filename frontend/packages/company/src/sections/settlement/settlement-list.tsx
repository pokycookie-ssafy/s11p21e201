...
//   DialogContent,
//   DialogActions,
// } from '@mui/material' // 예시로 @iconify/react를 사용했습니다. Iconify 설정에 따라 경로가 달라질 수 있습니다.
...
//         정산하기
//       </Button>
//       <Dialog open={openSettlementDialog} onClose={handleCloseSettlementDialog} maxWidth="sm" fullWidth>
//         <DialogTitle>정산하기</DialogTitle>
//         <DialogContent dividers>
//           <Stack sx={{ gap: 3, p: 2 }}>
//             <Typography variant="h6">송금할 계좌번호: 1002-954-436365 우리은행</Typography>
//             <Typography variant="h6">내 계좌번호: 1001-943-382901 국민은행</Typography>
//           </Stack>
//         </DialogContent>
//         <DialogActions sx={{ justifyContent: 'center' }}>
//           <Button variant="contained" onClick={handleCloseSettlementDialog}>송금하기</Button>
//         </DialogActions>
//       </Dialog>
...
//         </DialogContent>
//         <DialogActions sx={{ justifyContent: 'center' }}>
//           <Button variant="contained" onClick={handleCloseInvoiceDialog}>다운로드</Button>
//         </DialogActions>
//       </Dialog>
//     </Box>
//   );
